package fr.estia.net.bochaton.p.tp3.data.service
...
class DummyNeighborApiService : NeighborApiService {
    ...
    private val DUMMY_NeighborS: MutableList<Neighbor> = mutableListOf(
        Neighbor(
            1, "Caroline",
            "https://media.istockphoto.com/photos/girl-with-her-face-painted-with-her-own-hands-picture-id700492256",
        ...
        Neighbor(
            2,
            "Jack",
            "https://st2.depositphotos.com/3758943/6040/i/600/depositphotos_60400959-stock-photo-a-break-at-work.jpg",
            "Saint-Pierre-du-Mont ; 5km",
            "+33 6 00 55 90 14",
            (
        ...
        Neighbor(
            3,
            "Chloé",
            "https://st4.depositphotos.com/4504115/21173/i/1600/depositphotos_211733970-stock-photo-chloe-grace-moretz-walks-the.jpg",
